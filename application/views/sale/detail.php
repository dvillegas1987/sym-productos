            ...
            <div class="card-header border-0">
              ...
              <div class="row">
                <div class="col-lg-7 col-7">
                  <h5 class="h3">S&M Productos de limpieza e insumos médicos</h5>
                  <div class="h5 font-weight-400">
                    Buenos Aires 1796<br/>Teléfono: (+54)2995108728
                  </div>
                </div>
                <div class="col-lg-5 col-5 text-right">
                  <img style="max-height: 4rem;" src="<?php echo base_url(); ?>/assets/img/logotipo_sym_2.png"  alt="...">
                </div>

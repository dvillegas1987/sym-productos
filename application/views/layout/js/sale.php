...
<script>
    $(document).ready( function () {
        ...
        $("#btnSave").on("click", function(){ 
            ...
            sale(subtotal,igv,discount,total,clientId,voucherId,ids,prices,cants);
    ...
    function sale(subtotal,igv,discount,total,clientId,voucherId,ids,prices,cants){
        $.ajax({
            url: "<?php echo base_url();?>nuevo-venta/save",
            type: "POST",
            dataType:"json",
            data:{subtotal:subtotal,igv:igv,discount:discount,total:total,clientId:clientId,voucherId:voucherId,ids:ids,prices:prices,cants:cants},
            success: function(resp){
                Swal.fire({
                    type: resp.type,
                    title: 'Oops...',
